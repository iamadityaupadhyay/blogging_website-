...
class Migration(migrations.Migration):
    ...
    initial = True
    dependencies = [
    ('auth', '0012_alter_user_first_name_max_length'),  # Use the latest valid auth migration
]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='blog_category', to='myapp.category')),
            ],
        ),
    ]
